...
export async function HowItWorks({ locale }: { locale: string }) {
  ...
  return (
    <section id="how-it-works" className="relative overflow-hidden px-6 py-28 md:py-32">
      {/* Atmosphere */}
      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        ...
        <div className="mb-16 grid gap-8 lg:grid-cols-[0.88fr_1.12fr] lg:items-end">
          <div>
            ...
            <FadeIn delay={0.08}>
              <h2 className="max-w-2xl font-display text-5xl font-bold uppercase leading-[0.92] tracking-[-0.02em] text-white md:text-6xl lg:text-[4rem]">
                {t('title')}
              </h2>
            </FadeIn>
          </div>
          ...
          <FadeIn delay={0.16}>
            <div className="card-electric rounded-[2rem] p-6 backdrop-blur-xl">
              ...
              <p className="mt-4 text-sm leading-relaxed text-white/60">{t('note')}</p>
            </div>
          </FadeIn>
        </div>
            ...
            <StaggerItem key={index}>
              <article className="card-electric group relative flex h-full flex-col overflow-hidden rounded-[1.75rem] p-7 md:p-8">
                ...
                <div className="flex items-center gap-4">
                  <span className="tabular font-display text-[5.5rem] font-bold leading-[0.8] tracking-[-0.04em] text-electric md:text-[6.5rem]">
                    {step.number}
                  </span>
                ...
                <div className="mt-8 flex flex-1 flex-col">
                  ...
                  <p className="mt-4 max-w-sm text-sm font-light leading-relaxed text-white/70 md:text-base">
                    {step.desc}
                  </p>
                </div>
              </article>
