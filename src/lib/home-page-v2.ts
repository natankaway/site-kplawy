...
const COPY: Record<Locale, Copy> = {
  pt: {
    ...
    demoText: 'O vídeo abaixo foi capturado no app. Assista ao lance e veja o toque no relógio virar replay salvo.',
  ...
  en: {
    ...
    demoText: 'The video below was captured in the app. Watch the play and see the watch tap become a saved replay.',
