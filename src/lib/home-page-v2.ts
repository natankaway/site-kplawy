...
const COPY: Record<Locale, Copy> = {
  pt: {
    ...
    demoQuestion: 'Quanto do lance você quer salvar?',
    demoHint: 'O buffer continua rodando; somente a janela escolhida vira um clipe.',
    savedPrefix: 'Últimos',
    savedSuffix: 'salvos.',
  ...
  en: {
    ...
    demoQuestion: 'How much of the play do you want to save?',
